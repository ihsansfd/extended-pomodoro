...
{
    /// <summary>
    /// Interaction logic for MaximizableWindow.xaml
    /// </summary>
    public partial class MaximizableWindow : Window
    {
        ...
        public static readonly DependencyProperty IsLogoShownProperty =
            DependencyProperty.Register("IsLogoShown", typeof(bool), typeof(MaximizableWindow), new PropertyMetadata(false));

        public MaximizableWindow()
        {
            InitializeComponent();
        }
